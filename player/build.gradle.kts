...
android {
    namespace = "com.hiresplayer.player"
    compileSdk = 35
...
tasks.register<Test>("logicTest") {
    description = "Runs JVM tests for pure player logic."
    group = "verification"
    ...
    val asciiRoot = file("${System.getProperty("java.io.tmpdir")}/hiresplayer-tests/player")
